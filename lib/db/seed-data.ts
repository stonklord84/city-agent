  ...
  // ─── NEW YORK CITY ───────────────────────────────────────────────────────
  {
    ...
    neighborhoods: [
      ...
      },
      {
        ...
        slug: "greenpoint",
        summary:
          "North Brooklyn neighborhood with Polish roots, waterfront parks, indie restaurants, and a quieter creative feel than Williamsburg next door. Great for people who want cafes, calm side streets, and easy access to both Brooklyn and Manhattan.",
        vibeTags: ["waterfront", "creative", "calm", "food-forward", "neighborly"],
        bestForTags: ["coffee lovers", "couples", "remote workers", "waterfront walks"],
        rentMin: 3000,
        rentMax: 5000,
        walkabilityScore: 91,
        nightlifeScore: 72,
        ...
        places: [
          {
            ...
            category: "wellness",
            summary:
              "Small waterfront park with skyline views, lawns, and one of Greenpoint's best everyday sunset walks.",
            priceRange: "$",
            vibeTags: ["waterfront", "calm", "scenic"],
            bestForTags: ["sunset walks", "quiet weekends", "dates"],
            lat: 40.7297,
            lng: -73.9608,
            reviews: [],
          },
          {
            ...
            category: "food",
            summary:
              "Beloved wood-fired pizza spot that feels special without losing its neighborhood warmth.",
            priceRange: "$$",
            vibeTags: ["local", "food-forward", "cozy"],
            bestForTags: ["pizza nights", "date nights", "visiting friends"],
            lat: 40.7295,
            lng: -73.9585,
            reviews: [],
          },
      ...
      },
      {
        ...
        slug: "chelsea",
        summary:
          "Gallery-heavy west Manhattan neighborhood with the High Line, Chelsea Market, nightlife, gyms, and quick access to downtown and Midtown. A strong fit for people who want polished city life and lots to do within a few blocks.",
        vibeTags: ["gallery-district", "urban", "polished", "nightlife", "walkable"],
        bestForTags: ["art lovers", "young professionals", "gym-goers", "car-free living"],
        rentMin: 3800,
        rentMax: 7000,
        walkabilityScore: 98,
        nightlifeScore: 86,
        ...
        places: [
          {
            ...
            category: "wellness",
            summary:
              "Elevated linear park with gardens, public art, and easy walks through Chelsea and the Meatpacking District.",
            priceRange: "$",
            vibeTags: ["iconic", "walkable", "artsy"],
            bestForTags: ["walks", "visitors", "solo exploring"],
            lat: 40.748,
            lng: -74.0048,
            reviews: [],
          },
          {
            ...
            category: "practical",
            summary:
              "Food hall and market for lunch, groceries, gifts, and easy weekend exploring when you do not want to plan much.",
            priceRange: "$$",
            vibeTags: ["busy", "food-forward", "practical"],
            bestForTags: ["lunch", "groceries", "visiting friends"],
            lat: 40.7424,
            lng: -74.0061,
            reviews: [],
          },
      ...
      },
      {
        ...
        summary:
          "Classic residential Manhattan with Museum Mile, Central Park access, reliable errands, and quieter blocks east of the park. Best for people who want safety, stability, museums, and a polished daily routine.",
        vibeTags: ["classic", "residential", "safe", "museum-rich", "polished"],
        bestForTags: ["museum people", "families", "quiet Manhattan", "park access"],
        rentMin: 3200,
        rentMax: 6200,
        walkabilityScore: 96,
        nightlifeScore: 45,
        ...
        places: [
          {
            ...
            category: "practical",
            summary:
              "World-class museum on Museum Mile that can become an everyday cultural anchor instead of a tourist-only stop.",
            priceRange: "$$",
            vibeTags: ["cultural", "classic", "iconic"],
            bestForTags: ["museum people", "rainy days", "solo exploring"],
            lat: 40.7794,
            lng: -73.9632,
            reviews: [],
          },
          {
            ...
            slug: "central-park-reservoir",
            category: "wellness",
            summary:
              "Scenic running and walking loop with skyline views and a calmer rhythm than lower park sections.",
            priceRange: "$",
            vibeTags: ["green", "calm", "active"],
            bestForTags: ["runners", "morning walks", "park lovers"],
            lat: 40.7851,
            lng: -73.959,
            reviews: [],
          },
      ...
      },
      {
        ...
        summary:
          "Lower Manhattan high-rise living with fast transit, waterfront walks, newer apartment buildings, and a surprisingly quiet feel after work hours. Good for convenience-first renters who want Manhattan access without downtown nightlife on every block.",
        vibeTags: ["high-rise", "transit-rich", "waterfront", "practical", "polished"],
        bestForTags: ["commuters", "new apartment seekers", "car-free living", "waterfront walks"],
        rentMin: 3300,
        rentMax: 6000,
        walkabilityScore: 97,
        nightlifeScore: 58,
        ...
        places: [
          {
            ...
            category: "wellness",
            summary:
              "Waterfront park with harbor views, lawns, and an easy reset from the density of lower Manhattan.",
            priceRange: "$",
            vibeTags: ["waterfront", "green", "scenic"],
            bestForTags: ["walks", "runs", "quiet resets"],
            lat: 40.7033,
            lng: -74.017,
            reviews: [],
          },
          {
            ...
            slug: "eataly-downtown",
            category: "food",
            summary:
              "Large Italian market and dining hall that works for groceries, coffee, casual meals, and easy hosting.",
            priceRange: "$$",
            vibeTags: ["food-forward", "practical", "polished"],
            bestForTags: ["groceries", "casual dinners", "visiting friends"],
            lat: 40.7101,
            lng: -74.0119,
            reviews: [],
          },
      ...
      },
      {
        ...
        summary:
          "Historic brownstone Brooklyn with strong community identity, cafes, restaurants, leafy blocks, and better rent value than many nearby neighborhoods. A good fit for people who want character and space without leaving central Brooklyn.",
        vibeTags: ["brownstone", "community", "historic", "creative", "neighborly"],
        bestForTags: ["budget-aware renters", "coffee lovers", "community seekers", "brownstone blocks"],
        rentMin: 2400,
        rentMax: 4200,
        walkabilityScore: 86,
        nightlifeScore: 66,
        ...
        places: [
          {
            ...
            category: "food",
            summary:
              "Warm neighborhood Italian spot and bakery that captures Bed-Stuy's local, social dining rhythm.",
            priceRange: "$$",
            vibeTags: ["cozy", "local", "social"],
            bestForTags: ["date nights", "brunch", "neighborhood dinners"],
            lat: 40.6837,
            lng: -73.9347,
            reviews: [],
          },
          {
            ...
            category: "wellness",
            summary:
              "Neighborhood park with lawns, a cultural center, playgrounds, and a strong community feel.",
            priceRange: "$",
            vibeTags: ["community", "green", "local"],
            bestForTags: ["walks", "families", "weekend resets"],
            lat: 40.6896,
            lng: -73.9463,
            reviews: [],
      ...
      },
      {
        ...
        slug: "sunnyside",
        summary:
          "Low-key Queens neighborhood with quick 7 train access, practical shops, Irish pubs, cafes, and better rent value than many trendier areas. Good for people who want calm, convenience, and fast Manhattan access.",
        vibeTags: ["low-key", "practical", "neighborly", "transit-friendly", "affordable"],
        bestForTags: ["commuters", "budget-aware renters", "quiet routines", "car-free living"],
        rentMin: 2100,
        rentMax: 3300,
        walkabilityScore: 88,
        nightlifeScore: 52,
        ...
        places: [
          {
            ...
            category: "wellness",
            summary:
              "Leafy neighborhood green space that reinforces Sunnyside's quieter, community-first rhythm.",
            priceRange: "$",
            vibeTags: ["green", "calm", "community"],
            bestForTags: ["quiet weekends", "families", "walks"],
            lat: 40.7476,
            lng: -73.9207,
            reviews: [],
          },
          {
            name: "Skillman Avenue",
            slug: "skillman-avenue",
            category: "practical",
            summary:
              "Everyday corridor for cafes, restaurants, pubs, groceries, and the kind of errands that make a neighborhood easy to live in.",
            priceRange: "$$",
            vibeTags: ["practical", "local", "walkable"],
            bestForTags: ["errands", "coffee", "casual dinners"],
            lat: 40.7468,
            lng: -73.9193,
            reviews: [],
          },
      ...
      },
      {
        ...
        slug: "jersey-city",
        summary:
          "Dense waterfront city with PATH access to Manhattan, skyline views, restaurants, high-rises, brownstone pockets, and more apartment value than many NYC neighborhoods. Best for people who want NYC access with a little more breathing room.",
        vibeTags: ["waterfront", "commuter-friendly", "urban", "diverse", "practical"],
        bestForTags: ["Manhattan commuters", "new apartment seekers", "waterfront walks", "budget-aware renters"],
        rentMin: 2500,
        rentMax: 4700,
        walkabilityScore: 88,
        nightlifeScore: 70,
        ...
        places: [
          {
            ...
            category: "wellness",
            summary:
              "Huge waterfront park with Statue of Liberty views, skyline paths, and space that feels rare near Manhattan.",
            priceRange: "$",
            vibeTags: ["waterfront", "green", "scenic"],
            bestForTags: ["walks", "runs", "weekend resets"],
            lat: 40.7033,
            lng: -74.0522,
            reviews: [],
          },
          {
            ...
            category: "practical",
            summary:
              "Walkable restaurant, bar, coffee, and PATH hub that makes downtown Jersey City feel easy day to day.",
            priceRange: "$$",
            vibeTags: ["walkable", "social", "practical"],
            bestForTags: ["commuting", "dinner", "errands"],
            lat: 40.7196,
            lng: -74.0431,
            reviews: [],
          },
      ...
      },
      {
        ...
        slug: "hoboken",
        summary:
          "Compact, very walkable waterfront city with brownstones, bars, parks, PATH/ferry access, and a strong young-professional scene. Great for social renters who want Manhattan nearby but prefer a smaller-city rhythm.",
        vibeTags: ["walkable", "waterfront", "social", "young-professional", "compact"],
        bestForTags: ["young professionals", "commuters", "nightlife", "waterfront walks"],
        rentMin: 2800,
        rentMax: 5200,
        walkabilityScore: 96,
        nightlifeScore: 82,
        ...
        places: [
          {
            ...
            slug: "hoboken-waterfront-walkway",
            category: "wellness",
            summary:
              "Long skyline-facing walkway for runs, walks, dates, and decompressing after work.",
            priceRange: "$",
            vibeTags: ["waterfront", "scenic", "active"],
            bestForTags: ["runs", "walks", "dates"],
            lat: 40.744,
            lng: -74.0266,
            reviews: [],
          },
          {
            ...
            slug: "washington-street-hoboken",
            category: "nightlife",
            summary:
              "Main restaurant, bar, coffee, and errand corridor that keeps Hoboken highly walkable.",
            priceRange: "$$",
            vibeTags: ["social", "walkable", "busy"],
            bestForTags: ["drinks", "dinner", "errands"],
            lat: 40.7448,
            lng: -74.0299,
            reviews: [],
          },
